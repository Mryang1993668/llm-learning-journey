# RAG 实战：公司内部知识问答助手搭建全记录

> 本文记录了我基于 Dify 平台，从零搭建一个公司内部知识问答助手 demo 的完整过程。包含核心概念、架构设计、配置步骤、踩坑记录和最终成果。
...
安装通义插件：
左侧导航 → 插件 → 搜索 通义千问 → 安装（版本：0.1.30 稳定版）
配置模型供应商：
进入 设置 → 模型供应商 → 通义千问
填入阿里云百炼 API Key
...
截图见证：
![test1](images/test1.png?raw=true)
![test2](images/test2.png?raw=true)
![test3](images/test3.png?raw=true)
![test4](images/test4.png?raw=true)
![test5](images/test5.png?raw=true)
